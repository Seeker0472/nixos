  ...
  home-manager.sharedModules = [
    {
      wayland.windowManager.hyprland.settings = {
        ...
        bind = [
          ...
          # wofi
          # TODO!
          # "$mainMod, P, exec, bash ~/.config/wofi/wofi.sh menu"
          # "$mainMod SHIFT, P, exec, bash ~/.config/wofi/wofi.sh power"
          # "$mainMod CONTROL SHIFT, P, exec, cliphist list | wofi --dmenu | cliphist decode | wl-copy"

          ''$mainMod, P, exec, notify-send "TODO"''
          ''$mainMod SHIFT, P, exec, notify-send "TODO"''

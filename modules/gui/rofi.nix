...
let
  ...
  copyDirRecursively = fromDir: toDir:
    builtins.foldl' (a: b: a // b) (copyDir fromDir toDir) (lib.mapAttrsToList
      (name: value:
        copyDirRecursively (fromDir + "/${name}") (toDir + "/" + name))
  ...
  mkHomeFile = fromDir: toDir:
    ...
    (copyDirRecursively fromDir toDir);
in { home.file = mkHomeFile ./rofi ".local/share/rofi"; }
